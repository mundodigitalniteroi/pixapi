...
namespace NegocioCielo
{
    public class Payment : ReturnStatus
    {
        ...
        public Payment(decimal amount, PaymentType paymentType, Provider provider, string nossoNumero = "", string instrucao = "", string returnUrl = "", Currency currency = NegocioCielo.Currency.BRL, string country = NegocioCielo.Country.BRA)
        {
        ...
        /// <param name="country"></param>
        /// <param name="returnUrl">obrigatório quando é cartão de débito e transferência eletronica</param>
        public Payment(decimal amount, Currency currency, int installments, bool capture, string softDescriptor, Card card, PaymentType paymentType = PaymentType.CreditCard, string country = NegocioCielo.Country.BRA, string returnUrl = "", RecurrentPayment recurrentPayment = null, Wallet wallet = null)
        {
            SetPaymentType(paymentType);
            SetAmount(amount);
            SetCurrency(currency);
        ...
        /// <param name="country"></param>
        public Payment(decimal amount, Currency currency, int installments, string softDescriptor, Card card, RecurrentPayment recurrentPayment, string country = NegocioCielo.Country.BRA)
        {
